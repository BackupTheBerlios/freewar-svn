...
int	before_starting_game(t_engine *e, t_game_param *game_params);
...
// ailleurs..
int	open_windows(t_engine *e, t_db_info *db, t_cfg *cfg);
int	launch_demo();
int	init_global_game(t_engine *e, t_game_param *db, t_cfg *cfg, int type);
...
int		fw_recv_del_ent_in_map(t_engine *e, t_trame *t, int pl);
int		fw_recv_dir(t_engine *e, t_trame *trame, int pl);

// on network
int		init_net(t_engine *e);
void		process_newclient(t_client *c, const t_trame *t, void *d);
void		process_deadclient(t_client *c, const t_trame *t, void *d);
void		process_clients(t_client *c, const t_trame *t, void *d);
